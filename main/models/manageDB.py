...
def initializeDB(db):
    ...
    viewList.append(View(view_name = "jobs", view_group = "public", view_url = "/jobs", view_label = "Jobs", view_icon = "fa-solid fa-tower-observation fa-fw", view_type = "PAGE", view_tab = False, allow_read_default = False, allow_create_default = False, allow_edit_default = False, allow_delete_default = False))
    viewList.append(View(view_name = "myapplication", view_group = "public", view_url = "/jobs/myapplication", view_label = "My Applications", view_icon = "fa-regular fa-user fa-fw", view_type = "PAGE", view_tab = False, allow_read_default = False, allow_create_default = False, allow_edit_default = False, allow_delete_default = False))
